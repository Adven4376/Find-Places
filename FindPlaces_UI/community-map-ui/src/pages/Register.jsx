...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-blue-50 via-gray-100 to-emerald-50 dark:from-gray-900 dark:via-[#0f172a] dark:to-gray-800 -mt-[72px]">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">
            Join FindPlaces to discover your next destination.
          </p>
        </div>
        ...
        <button className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold py-3 rounded-xl hover:shadow-lg hover:shadow-emerald-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200">
          Sign Up
        </button>
